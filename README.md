...
* include the **dpdaterangepicker-0.0.1.min.js** and the **dpdaterangepicker-0.0.1.min.css** files into your project. See the **Build project** and the **Installation** chapters below.
```html
<script src="dpdaterangepicker-0.0.1.min.js"></script>
<link href="dpdaterangepicker-0.0.1.min.css" rel="stylesheet" type="text/css">
```
